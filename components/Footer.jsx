  ...
  return (
    <footer className="bg-white dark:bg-gray-900">
      <div className="mx-auto w-full">
        <div className="grid gap-8 w-full max-w-screen-xl px-6 py-4 lg:py-8 md:grid-cols-4 sm:grid-cols-2">
          {/* Contact Us Section */}
          <div className="mx-auto text-center sm:text-left">
            ...
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
              <li className="mb-4">
                <a href="https://www.linkedin.com/in/sahil-ahmad-52b6522a8/" className="hover:underline">LinkedIn</a>
              </li>
              <li className="mb-4">
                <a href="https://x.com/SahilAh42663686" className="hover:underline">X (Twitter)</a>
              </li>
              <li className="mb-4">
                <a href="https://github.com/SAHILAHMAD9" className="hover:underline">GitHub</a>
              </li>
            </ul>
          </div>
          {/* Legal Section */}
        ...
        <div className="px-12 py-6 w-full bg-gray-200 dark:bg-gray-700 flex flex-col sm:flex-row items-center justify-between">
